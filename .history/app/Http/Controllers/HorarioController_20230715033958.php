...
class HorarioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $request = Horario::create($validatedData);
            // Resto del código para redireccionar o mostrar un mensaje de éxito, etc.
        } catch (\Exception $e) {
            // Manejo de la excepción, por ejemplo, mostrar un mensaje de error o registrar el error en un archivo de registro.
            dd($e->getMessage()); // Imprimir mensaje de error en la página para propósitos de depuración.
        }
