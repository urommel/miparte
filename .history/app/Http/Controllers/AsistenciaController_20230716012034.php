...
class AsistenciaController extends Controller
{
    ...
    {
        //
        $personal = Personal::all(); // Obtén todos los personales
        $asistencias = Asistencia::all(); // Obtén todas las asistencias
    ...
    public function store(Request $request)
    {
        ...
        $diaAsignado = $request->personal()->horario->dia; // Asegúrate de ajustar esto según la estructura de tu base de datos y tus modelos
