...
class AsistenciaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (in_array($diaActual, $diasAsignados)) {
            // El día actual está dentro de los días asignados
            // Realiza aquí las acciones que deseas para este caso

            // Ejemplo: Crear un nuevo objeto de asistencia
            ...
            // El día actual no está dentro de los días asignados
            return redirect()->back()->with('error', 'No puedes registrar la asistencia hoy.');
        }


        // $nombreDiaActual = $request->diaH[$diaActual];

        // $horarioPermitido = in_array($nombreDiaActual, $request->diaH);
