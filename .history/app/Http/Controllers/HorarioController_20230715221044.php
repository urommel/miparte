...
class HorarioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $datosHorarios = $request->validate([
            'horarios.*.trabaja' => 'required|boolean',
        ...
        try {
            ...
            foreach ($datosHorarios['horarios'] as $dia => $datosDia) {
                Horario::create([
                    'dia' => $dia,
            ...
            return response()->json(['message' => 'Error al guardar los horarios'], 500);
        }
