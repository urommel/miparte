...
class HorarioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($horarios as $dia => $detalle) {
            echo $trabaja = $detalle['trabaja'];
            echo $horaInicio = $detalle['hora_inicio'];
            echo $horaFin = $detalle['hora_fin'];
            ...
            // por ejemplo, utilizando consultas SQL o mediante el uso de Eloquent ORM en Laravel.
