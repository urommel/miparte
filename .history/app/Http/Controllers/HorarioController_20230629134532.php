...
class HorarioController extends Controller
{
    ...
    public function create()
    {
        ...
        // $horario = Horario::where('id', '=', 1)->first();
        // $horario = Horario::where('personal_id', auth()->id())->get();
        // hacer una busquedad de los horarios del usuario logueado
        ...
        // $horario = new Horario();
        return view('horario.create', compact('dias','horario'));
    }
