...
class PersonalController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        //Llamamos a method App\Models\Personal::getGeneroOptions() para obtener los valores de la columna genero
        ...
        return view('personal.create', compact('personal','rol', 'personals'));
    }
