                            ...
                            <table class="table table-striped table-md">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="customRadioInline3" name="estado" class="custom-control-input" value="tardanza" onclick="habilitarJustificacion(true)">
                                            <label class="custom-control-label" for="customRadioInline3">Tardanza</label>
                                        </div>

                                        <div id="minutosTardanza" style="display: none;">
