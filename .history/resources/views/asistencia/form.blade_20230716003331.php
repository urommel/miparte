<div class="box box-info padding-1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="customRadioInline1" name="estado" class="custom-control-input" value="asistio" onclick="habilitarJustificacion(false)">
                                            <label class="custom-control-label" for="customRadioInline1">Asistió</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="customRadioInline2" name="estado" class="custom-control-input" value="no_asistio" onclick="habilitarJustificacion(true)">
                                            <label class="custom-control-label" for="customRadioInline2">No asistió</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="customRadioInline3" name="estado" class="custom-control-input" value="tardanza" onclick="habilitarJustificacion(true); mostrarCampoTardanza(true)">
                                            <label class="custom-control-label" for="customRadioInline3">Tardanza</label>
                                        </div>

                                        <div id="justificacionDiv" style="display: none;">
                                            <label for="justificacion">Justificación:</label>
                                            <input type="text" class="form-control" name="justificacion" id="justificacionInput" disabled>
                                        </div>
    ...
    <script>
        ...
        function mostrarCampoTardanza() {
            var campoTardanza = document.getElementById("campoTardanza");
            var radioTardanza = document.getElementById("customRadioInline3");

            if (radioTardanza.checked) {
