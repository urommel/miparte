<div class="box box-info padding-1">
                            ...
                            <table class="table table-striped table-md">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="customRadioInline3" name="estado" class="custom-control-input" value="tardanza" onclick="habilitarJustificacion(false); mostrarCampoTardanza(true)">
    ...
    <script>
        function habilitarJustificacion(deshabilitar) {
            ...
            var justificacionDiv = document.getElementById("justificacionDiv");
            if (deshabilitar) {
