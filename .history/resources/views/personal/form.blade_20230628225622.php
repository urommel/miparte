<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('email') }}
            {{ Form::text('email', $personal->email, ['class' => 'form-control', 'autocomplete' => 'off' . ($errors->has('email') ? ' is-invalid' : ''), 'placeholder' => 'Email']) }}
            {!! $errors->first('email', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('password') }}
            {{ Form::password('password', $personal->password, ['class' => 'form-control','autocomplete' => 'off' . ($errors->has('password') ? ' is-invalid' : ''), 'placeholder' => 'Password']) }}
