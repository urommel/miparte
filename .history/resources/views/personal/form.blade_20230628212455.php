<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('password_confirmation', $personal->password_confirmation, ['class' => 'form-control' . ($errors->has('password_confirmation') ? ' is-invalid' : ''), 'placeholder' => 'Password Confirmation']) }}
        ...
        {{-- <div class="form-group">
            {{ Form::label('roles') }}
            {{ Form::text('roles', $personal->roles, ['class' => 'form-control' . ($errors->has('roles') ? ' is-invalid' : ''), 'placeholder' => 'Roles']) }}
