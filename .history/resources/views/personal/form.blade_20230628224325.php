<div class="box box-info padding-1">
    <div class="box-body">
        ...
        Colocar una casilla de password con laravel colective que se pueda ocultar y mostrar
        <div class="form-group">
            {{ Form::label('foto') }}
            {{ Form::text('foto', $personal->foto, ['class' => 'form-control' . ($errors->has('foto') ? ' is-invalid' : ''), 'placeholder' => 'Foto']) }}
