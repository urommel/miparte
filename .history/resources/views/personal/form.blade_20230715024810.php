<div class="box box-info padding-1">
    <div class="box-body">
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control" name="genero">
                    ...
                    @foreach ($personal->getGeneroOptions() as $key => $value)
                        <option value="{{ $key }}" {{ $personal->genero == $value ? 'selected' : '' }}>{{ $value }}</option>
                    @endforeach
                </select>
            ...
            <label for="dia_lunes">
                <input type="checkbox" name="dias[]" value="Lunes" id="dia_lunes" {{ in_array('Lunes', $personal->horario->dias) ? 'checked' : '' }}>
                Lunes
            </label>
