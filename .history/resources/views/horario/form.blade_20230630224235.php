<div class="box box-info padding-1">
    <div class="box-body">
        <div class="m-3">
            <h5>Hola, {{ \Illuminate\Support\Facades\Auth::user()->name }}
             {{ $dd->user()->first()->name }} </h5>
                ...
                @foreach ($dias as $dia)
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <div class="col">
                                    <select class="form-control" name="hora_inicio_{{$dia}}" id="hora_inicio_{{$dia}}" disabled>
                                        @for ($i = 7; $i <= 12; $i++)
                        ...
                        <td>
                            <div class="row">
                                <div class="col">
                                    <select class="form-control" name="hora_fin_{{$dia}}" id="hora_fin_{{$dia}}" disabled>
                                        @for ($i = 1; $i <= 6; $i++)
