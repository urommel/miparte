            ...
            <tbody>
                @foreach (['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado', 'Domingo'] as $dia)
                    <tr>
                        <td>{{ $dia }}</td>
                        <td>
                            <input type="checkbox" name="horarios[{{ strtolower($dia) }}][trabaja]" value="1" {{ $personals->horario->horarios[strtolower($dia)]['trabaja'] ? 'checked' : '' }}>
                        </td>
                        <td>
                            <input type="time" name="horarios[{{ strtolower($dia) }}][hora_inicio]" value="{{ $personals->horario->horarios[strtolower($dia)]['hora_inicio'] ?? '' }}">
                        </td>
                        <td>
                            <input type="time" name="horarios[{{ strtolower($dia) }}][hora_fin]" value="{{ $personals->horario->horarios[strtolower($dia)]['hora_fin'] ?? '' }}">
                        </td>
                    </tr>
                @endforeach
            </tbody>
