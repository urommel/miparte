                ...
                @foreach ($dias as $dias)
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="form-group m-3" style="height: 20px;width: 20px;">
                                {{ Form::checkbox('dia', $dias, ['class' => 'form-control ','style'=>'height: 20px' . ($errors->has('dia') ? ' is-invalid' : ''), 'placeholder' => 'Dia']) }}
                                <br>
                            </div>
