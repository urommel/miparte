        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            checkboxes.forEach(function(checkbox) {
                checkbox.addEventListener('change', function() {
                    const horaInicioInput = this.parentNode.nextElementSibling.querySelector('.hora-inicio');
                    const horaFinInput = this.parentNode.nextElementSibling.nextElementSibling.querySelector('.hora-fin');
                    horaInicioInput.disabled = !this.checked;
                    horaFinInput.disabled = !this.checked;
                });
            });
        });
    </script>
