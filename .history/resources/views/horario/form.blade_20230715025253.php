                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="horarios[{{ strtolower($dia) }}][trabaja]" value="1"
                                {{ $personal->horario->horarios[strtolower($dia)]['trabaja'] ? 'checked' : '' }}>
                        </td>
                        <td>
                            <input type="time" name="horarios[{{ strtolower($dia) }}][hora_inicio]"
                                value="{{ $personal->horario->horarios[strtolower($dia)]['hora_inicio'] ?? '' }}">
                        </td>
                        <td>
                            <input type="time" name="horarios[{{ strtolower($dia) }}][hora_fin]"
                                value="{{ $personal->horario->horarios[strtolower($dia)]['hora_fin'] ?? '' }}">
                        </td>
                    </tr>
                @endforeach
            </tbody>
