                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="active[]" value="{{ $key}} @if ($horario->active)checked @endif">
                            </div>
                        </td>
                        <td>
                            <div class="row">
