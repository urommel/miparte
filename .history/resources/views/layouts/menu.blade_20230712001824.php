    ...
    <ul class="sidebar-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="{{ route('role')}}">Roles</a></li>
            </ul>
        </li>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('personal')}}">Ver</a></li>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('horario') }}">Ver</a></li>
                <li><a class="nav-link" href="layout-transparent.html">Crear</a></li>
            </ul>
        </li>
